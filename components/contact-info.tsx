    ...
    <div className="space-y-8">
      ...
      <Card className="bg-gradient-to-r from-evergreen-medium to-evergreen-light text-white shadow-lg">
        <CardContent className="p-6 text-center">
          ...
          <p className="mb-4">Join hundreds of satisfied customers who trust EverGreen for their agricultural needs.</p>
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            <span className="bg-white/20 px-4 py-2 rounded-lg text-sm">✓ Quality Guaranteed</span>
            <span className="bg-white/20 px-4 py-2 rounded-lg text-sm">✓ Fast Response</span>
            <span className="bg-white/20 px-4 py-2 rounded-lg text-sm">✓ Expert Support</span>
          </div>
        </CardContent>
      </Card>
    </div>
